# Generated by Powerlevel10k configuration wizard on 2020-04-12 at 19:24 CEST.
...
() {
  ...
  # Disable gitstatusd (not cool to download binaries over the internet without notice)
